        ...
        <ul class="nav nav-secondary">
          <li class="nav-item active">
            <a href="">
              ...
              <p class="header-menu">Trang chủ</p>
            </a>
          </li>
          <li class="nav-item active">
            <a href="">
              <ion-icon name="people-outline"></ion-icon>
              <p class="header-menu">Quản lý khách hàng</p>
            </a>
          </li>
          <li class="nav-item active">
            <a href="">
              <img src={iconQLSP} class="icon-sidebar" />
              <p class="header-menu">Quản lý sản phẩm</p>
            </a>
          </li>
          <li class="nav-item active">
            <a href="">
              <img src={iconQLBH} class="icon-sidebar" />
              <p class="header-menu">Quản lý bảo hành</p>
            </a>
          </li>
          <li class="nav-item active">
            <a href="">
              <img src={iconQLHD} class="icon-sidebar" />
              <p class="header-menu">Quản lý hóa đơn</p>
            </a>
          </li>
          <li class="nav-item active">
            <a href="">
              <img src={iconQLBT} class="icon-sidebar" />
              <p class="header-menu">Quản lý bảo trì</p>
            </a>
          </li>
        </ul>
      </div>
